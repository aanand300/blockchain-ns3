...
/*   double bitcoinMinersHash[] = {0.4, 0.3, 0.3};
  ...
  else //filling the array minersHash & minersRegions using 16 entries of bitcoinMinersHash & bitcoinMinersRegions resp.
  {
    minersHash = new double[noMiners];
	minersRegions = new enum BitcoinRegion[noMiners];
...
#else //this #else is corresponding to #ifdef NS3_MPI (in Line number - 46)
  NS_FATAL_ERROR ("Can't use distributed simulator without MPI compiled in");
#endif //this #endif is corresponding to #ifdef NS3_MPI (in Line number - 46)
}
